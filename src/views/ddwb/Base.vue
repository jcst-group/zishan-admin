                ...
                <span slot="action" slot-scope="text, record">
                  <a-dropdown>
                      ...
                      <a-menu slot="overlay">
                        ...
                        <a-menu-item >
                          <a href="javascript:;" @click="addenv(record)">编辑检测项</a>
                        </a-menu-item>
                          <a-menu-item >
...
import addbaseenv from '@/views/ddwbmodule/addbaseenv'
...
export default {
    ...
    methods:{
     clicktab(record, index){
      ...
      addenv(record){
        this.$refs.addbaseenv.add(record);
      },
      edit(record){
