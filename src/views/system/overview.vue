...
import {getBatchByBase, getAllBatch, getAllWorkType, getAllWorklist, getAllWorkStatus, exportWorkList, updateOrderRole, getPlantingAll} from '@/api/permissonApi'
...
export default {
    ...
    methods: {
        ...
        _loadData() {
            ...
            if (params.baseId && params.baseId.value == -1) {
                delete params.baseId
            } else {
                params.baseId = params.baseId ? params.baseId.value : null
            }
