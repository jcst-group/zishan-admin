...
const getBackPicName = (params)=>getAction("/platform-info/getBackPicName",params);
/*公司信息管理*/
...
/*检测模板*/
const detectionTemplate = (params)=>getAction("/detectionTemplate/list",params);
const detectionTemplateAdd = (params)=>postAction("/detectionTemplate/add",params);
const detectionTemplateDel = (params)=>getAction("/detectionTemplate/delete",params);
const detectionTemplateUpdate = (params)=>postAction("/detectionTemplate/update",params);
const envStandards = (params)=>getAction("/envStandards/all",params);
/*检测模板*/

const detectionTemplateAll = (params)=>getAction("/detectionTemplate/all",params);
const selectByTemplateId = (params)=>getAction("/envStandards/selectByTemplateId",params);
const addDetection =(params) =>postAction("/baseInfo/addDetection",params);
const getEnvStandardsEnum = (params) =>getAction("/enum/getEnvStandardsEnum",params);
const copyTemplate = params => getAction('/detectionTemplate/copyTemplate', params)
const getTemplateStandardType = (params) =>getAction("/enum/getTemplateStandardType",params);
const getLogoPic =(params) =>getAction("/platform-info/getLogoPic",params);

export {
  getLogoPic,
  getBackPicName,
  getTemplateStandardType,
  addDetection,
  selectByTemplateId,
  detectionTemplateAll,
  envStandards,
  detectionTemplateUpdate,
  detectionTemplateDel,
  detectionTemplateAdd,
  detectionTemplate,
  getFruitColorEnum,
  addCompanyExpect,
  delCompanyExpect,
