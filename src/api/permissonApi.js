...
// 紫衫工单接口
const addzsOrder = params => postAction('/zsWorkorder/add', params)
const updatezsOrder = params => postAction('/zsWorkorder/update', params)
const getzsOrder = params => getAction('/zsWorkorder/list', params)
const deletezsOrder = params => getAction('/zsWorkorder/delete', params)
const getAllBaseZS = params => getAction('/baseInfo/all', params)

// 检测类型接口
const addStandardType = params => postAction('/standardType/add', params)
const updateStandardType = params => postAction('/standardType/update', params)
const deleteStandardType = params => getAction('/standardType/delete', params)
const getStandardType = params => getAction('/standardType/list', params)
const checkStandardType = params => getAction('/standardType/check', params)

// 平台信息接口
const platformType = params => getAction('/enum/getPlatformEnum', params)
const addPlatform = params => postAction('/platform-info/add', params)
const updatePlatform = params => postAction('/platform-info/update', params)
